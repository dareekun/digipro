                    ...
                    <form id="masuk" name="masuk" action="/mesin3" method="post">
                        ...
                        <table style="width:100%">
                            <tr>
                                ...
                                <td style="width:10%" align="center"><input type="number" value="{{$data5->durasi}}" min="0" class="form-control" name="reslt1"></td>
                                <td style="width:8%">C/T Mesin</td>
                                <td style="width:10%" align="center"><input type="number" value="{{$data5->cycle}}" step="0.001" min="0" class="form-control" name="reslt2"></td>
                                <td style="width:10%">Detail Masalah</td>
                                <td style="width:15%" align="center"><input type="text" value="{{$data5->detail}}" class="form-control" name="reslt3"></td>
                            </tr>
                            <tr>
                                <td>Hasil Produksi</td>
                                <td align="center"><input type="number" min="0" value="{{$data5->hasil}}" class="form-control" name="reslt4"></td>
                                <td >Defect (NG)</td>
                                <td align="center"><input type="number" min="0" value="{{$data5->defect}}" class="form-control" name="reslt5"></td>
                                <td >Waktu Kerja Actual</td>
                                <td align="center"><input type="number" min="0" value="{{$data5->waktu}}" class="form-control" name="reslt6"></td>
                            </tr>
                            <tr>
                                <td >Planning Produksi</td>
                                <td align="center"><input type="number" min="0" value="{{$data5->planning}}" class="form-control" name="reslt7"></td>
                            </tr>
                            <tr>
                                <td>Effisiensi</td>
                                <td align="center"><input type="number" min="0" value="{{$data5->eff}}" class="form-control" name="reslt8"></td>
                                <td >Total Loss Time</td>
                                <td align="center"><input type="number" min="0" value="{{$data5->total}}" class="form-control" name="reslt9"></td>
                            </tr>
                        </table>
                        <br>
                        <table style="width:100%">
