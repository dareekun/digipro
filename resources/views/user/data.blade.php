    ...
    <div class="row justify-content-center">
        <div class="col-md-12">
            <div class="card">
                ...
                <div class="row">
                        <div class="col-md-4">
                            Input Produksi {{$bagian}}
                        </div>
                        <div class="col-md-4">
                        </div>
                        <div class="col-md-4" align="right"><div id="MyClockDisplay" onload="showTime()"></div>
                        </div>
                    </div>
                </div>
                <div class="card-body">
                                            ...
                                            <table>
                                                <tr>
                                                    ...
                                                    <td> <input type="date" class="form-control"
                                                            value="{{ date('Y-m-d') }}" name="tanggal"></td>
                                                </tr>
                                                <tr>
                                                    <td>Line</td>
                                                ...
                                                <tr>
                                                    <td>Pic</td>
                                                    <td> <input type="text" required class="form-control" name="pic">
                                                    </td>
                                                </tr>
                                                <tr>
                                                    <td>Shift</td>
                                        ...
                                        <td>
                                            <table>
                                                <tr>
                                                    ...
                                                    <td> <input required type="number" style="width:100px"
                                                            class="form-control" name="kartap"></td>
                                                    <td>Absen </td>
                                                    <td> <input required type="number" value="0" style="width:100px"
                                                            class="form-control" name="absenkartap"></td>
                                                    <td>Waktu Kerja</td>
                                                    <td> <input disabled type="number" style="width:100px"
                                                            class="form-control" name="waktukartap"></td>
                                                    <td>Overtime </td>
                                                    <td> <input required type="number" style="width:100px" value="0"
                                                            class="form-control" name="otkartap"></td>
                                                </tr>
                                                <tr>
                                                    ...
                                                    <td>Absen </td>
                                                    <td> <input required type="number" value="0" style="width:100px"
                                                            class="form-control" name="absenkwt"></td>
                                                    <td>Waktu Kerja</td>
                                                    <td> <input disabled type="number" style="width:100px"
                                                            class="form-control" name="waktukwt"></td>
                                                    <td>Overtime </td>
                                                    <td> <input required type="number" style="width:100px" value="0"
                                                ...
                                                <tr>
                                                    ...
                                                    <td><input required disabled type="number" style="width:100px"
                                                            class="form-control" name="jmlop"></td>
                                                    <td>Start </td>
                                                    <td> <input disabled type="time" style="width:100px"
                                                            class="form-control" name="start"></td>
                                                    <td>Finish </td>
                                                    <td> <input disabled type="time" style="width:100px"
                                                            class="form-control" name="finish"></td>
                                                    <td>Waktu Kerja T.T </td>
                                                    <td> <input required type="number" disabled style="width:100px"
                                                            class="form-control" name="wktkrj"></td>
                                                </tr>
                                            </table>
                                        </td>
                                    </tr>
