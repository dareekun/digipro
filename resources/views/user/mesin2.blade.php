                    ...
                    <form id="masuk" name="masuk" action="/mesin3" method="post">
                            ...
                            <tr>
                                <td>
                                    ...
                                    <table>
                                        ...
                                        <tr>
                                            <td>Nomor Mesin</td>
                                            <td> <input type="number" value="{{$d->line}}" min="0" max="28" required
                                                    class="form-control" name="nomor"></td>
                                        </tr>
                                        <tr>
                                            <td>Shift</td>
                                ...
                                <td>
                                    <table>
                                        <tr>
                                            <td>Nama PIC </td>
                                            <td> <input type="text" value="{{$d->pic}}" style="width:250px"
                                                    class="form-control" name="pic"></td>
                                        </tr>
                                        <tr>
                                            <td>Nama Part/Product </td>
                                            <td><input type="text" value="{{$d->part}}" style="width:250px"
                                                    class="form-control" name="tipe"></td>
                                        </tr>
                                        <tr>
                                            <td>Start Production </td>
                                            <td><input type="time" value="{{$d->start}}" disabled style="width:250px"
                                                    class="form-control" name="start"></td>
                                        </tr>
                                        <tr>
                                            <td>Finish Production</td>
                                            <td><input type="time" value="{{$d->finish}}" disabled style="width:250px"
                        ...
                        <table>
                            ...
                            <tr>
                                ...
                                <td><select required name="regprob" class="custom-select">
                                        ...
                                        @foreach($lossa as $a)
                                        <option @if($a->loss===$d1->problem) selected @else @endif
                                ...
                                <td align="right"><button class="btn btn-danger" type="submit" onclick="del1()"
                                        name="rem1"><i class="fa fa-minus-circle" aria-hidden="true"></i></button></td>
                            </tr>
                            @endforeach
                            <tr>
                                <td></td>
                                <td><select required name="regprob0" class="custom-select">
                                        ...
                                        @endforeach</td>
                                <td><input type="time" style="width:100px" class="form-control" name="regstart0"></td>
                                <td><input type="time" style="width:100px" class="form-control" name="regfinish0"></td>
                                <td><input type="number" style="width:100px" class="form-control" name="regdur0"></td>
                        ...
                        <table>
                            ...
                            <tr>
                                ...
                                <td><select name="wrkprob" class="custom-select">
                                        <option value="Tidak Ada Masalah">Tidak Ada Masalah</option>
                                        @foreach($lossb as $b)
                                        <option @if($b->loss===$d2->problem) selected @else @endif
                                            value="{{$b->loss}}">{{$b->loss}}</option>
                                        @endforeach</td>
                                ...
                                <td align="right"><button class="btn btn-danger" type="submit" onclick="del2()"
                                        name="rem2"><i class="fa fa-minus-circle" aria-hidden="true"></i></button></td>
                            </tr>
                            @endforeach
                            <tr>
                                <td></td>
                                <td><select name="wrkprob0" class="custom-select">
                                        ...
                                        @endforeach</td>
                                <td><input type="time" style="width:100px" class="form-control" name="wrkstart0"></td>
                                <td><input type="time" style="width:100px" class="form-control" name="wrkfinish0"></td>
                                <td><input type="number" style="width:100px" class="form-control" name="wrkdur0"></td>
                        ...
                        <table>
                            ...
                            <tr>
                                ...
                                <td><select name="orprob" class="custom-select">
                                        <option value="Tidak Ada Masalah">Tidak Ada Masalah</option>
                                        @foreach($lossc as $c)
                                        <option @if($c->loss===$d3->problem) selected @else @endif
                                            value="{{$c->loss}}">{{$c->loss}}</option>
                                        @endforeach</td>
                                ...
                                <td align="right"><button class="btn btn-danger" type="submit" onclick="del3()"
                                        name="rem3"><i class="fa fa-minus-circle" aria-hidden="true"></i></button></td>
                            </tr>
                            @endforeach
                            <tr>
                                <td></td>
                                <td><select name="orprob0" class="custom-select">
                                        ...
                                        @endforeach</td>
                                <td><input type="time" style="width:100px" class="form-control" name="orstart0"></td>
                                <td><input type="time" style="width:100px" class="form-control" name="orfinish0"></td>
                                <td><input type="number" style="width:100px" class="form-control" name="ordur0"></td>
                        ...
                        <table>
                            ...
                            <tr>
                                ...
                                <td><select name="defprob" class="custom-select">
                                        <option value="Tidak Ada Masalah">Tidak Ada Masalah</option>
                                        @foreach($lossd as $d)
                                        <option @if($d->loss===$d4->problem) selected @else @endif
                                            value="{{$d->loss}}">{{$d->loss}}</option>
                                        @endforeach</td>
                                ...
                                <td align="right"><button class="btn btn-danger" type="submit" onclick="del4()"
                                        name="rem4"><i class="fa fa-minus-circle" aria-hidden="true"></i></button></td>
                            </tr>
                            @endforeach
                            <tr>
                                <td></td>
                                <td><select name="defprob0" class="custom-select">
                                        ...
                                        @endforeach</td>
                                <td><input type="time" style="width:100px" class="form-control" name="defstart0"></td>
                                <td><input type="time" style="width:100px" class="form-control" name="deffinish0"></td>
                                <td><input type="number" style="width:100px" class="form-control" name="defdur0"></td>
                        ...
                        <table style="width:100%">
                            <tr>
                                ...
                                <td style="width:10%" align="center"><input type="number" value="{{$d5->durasi}}" min="0"
                                        class="form-control" name="reslt1"></td>
                                <td style="width:8%">C/T Mesin</td>
                                <td style="width:10%" align="center"><input type="number" value="{{$d5->cycle}}" step="0.001" min="0"
                                        class="form-control" name="reslt2"></td>
                                <td style="width:10%">Detail Masalah</td>
                                <td style="width:15%" align="center"><input type="text" value="{{$d5->detail}}" class="form-control"
                                        name="reslt3"></td>
                            </tr>
                            <tr>
                                <td>Hasil Produksi</td>
                                <td align="center"><input type="number" min="0" value="{{$d5->hasil}}" class="form-control"
                                        name="reslt4"></td>
                                <td>Defect (NG)</td>
                                <td align="center"><input type="number" min="0" value="{{$d5->defect}}" class="form-control"
                                        name="reslt5"></td>
                                <td>Waktu Kerja Actual</td>
                                <td align="center"><input type="number" min="0" value="{{$d5->waktu}}" class="form-control"
                                        name="reslt6"></td>
                            </tr>
                            <tr>
                                <td>Planning Produksi</td>
                                <td align="center"><input type="number" min="0" value="{{$d5->planning}}" class="form-control"
                                        name="reslt7"></td>
                            </tr>
                            <tr>
                                <td>Effisiensi</td>
                                <td align="center"><input type="number" min="0" value="{{$d5->eff}}" class="form-control"
                                        name="reslt8"></td>
                                <td>Total Loss Time</td>
                                <td align="center"><input type="number" min="0" value="{{$d5->total}}" class="form-control"
                                        name="reslt9"></td>
                            </tr>
                        </table>
                        @empty
                        <table style="width:100%">
                            <tr>
                                <td style="width:10%">Durasi Kerja</td>
                                <td style="width:10%" align="center"><input type="number" value="" min="0"
                                        class="form-control" name="reslt1"></td>
                                <td style="width:8%">C/T Mesin</td>
                                <td style="width:10%" align="center"><input type="number" value="" step="0.001" min="0"
                                        class="form-control" name="reslt2"></td>
                                <td style="width:10%">Detail Masalah</td>
                                <td style="width:15%" align="center"><input type="text" value="" class="form-control"
                                        name="reslt3"></td>
                            </tr>
                            <tr>
                                <td>Hasil Produksi</td>
                                <td align="center"><input type="number" min="0" value="" class="form-control"
                                        name="reslt4"></td>
                                <td>Defect (NG)</td>
                                <td align="center"><input type="number" min="0" value="" class="form-control"
                                        name="reslt5"></td>
                        ...
                        <table style="width:100%">
                            <tr>
                                ...
                                <td align="right"><button type="submit" class="btn btn-success" name="emilia"
                                        onclick="data5()">Next</button></td>
                            </tr>
                        </table>
                    </form>
                </div>
