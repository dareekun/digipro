<div>
    ...
    <table style="width:100%">
        ...
        <tr>
            ...
            <td>
                <input wire:model.defer="rekap.start" type="time" class="form-control w-100">
            </td>
            <td>
                <input wire:model.defer="rekap.stop" type="time" class="form-control w-100">
            </td>
            <td>
                <input wire:model.defer="rekap.plan" type="number" min="0" class="form-control w-100">
            </td>
            <td>
                <input wire:model.defer="rekap.actual" type="number" min="0" class="form-control w-100">
            </td>
            <td>
                <input wire:model.defer="rekap.process" type="number" min="0" class="form-control w-100">
            </td>
            <td>
                <input wire:model.defer="rekap.material" type="number" min="0" class="form-control w-100">
            </td>
        </tr>
        <tr>
            <td colspan="6">Ket</td>
        ...
        <tr>
            <td colspan="6">
                <input wire:model.defer="rekap.ket" type="text" class="form-control w-100">
            </td>
            <td><button class="btn btn-success" type="submit" wire:click="addproduct">Submit</button></td>
        </tr>
    </table>
    <br>
    <table style="width:100%">
        ...
        @foreach($data5 as $d5)
        <tr>
            <td><input disabled value="{{$d5->tipe}}" type="text" style="width:150px" class="form-control-plaintext">
            </td>
            <td><input disabled value="{{$d5->start}}" type="time" style="width:100px" class="form-control-plaintext">
            </td>
            <td><input disabled value="{{$d5->stop}}" type="time" style="width:100px" class="form-control-plaintext"
                    name="rekstop"></td>
            ...
            <td><input disabled value="{{$d5->daily_actual}}" type="text" min="0" class="form-control-plaintext">
            </td>
            ...
            <td><input disabled value="{{$d5->ng_material}}" type="text" min="0" class="form-control-plaintext">
            </td>
    ...
    <table>
        <tr>
            <td><select wire:model.defer="problem01.masalah" class="custom-select">
                    <option selected value="Tidak Ada Masalah">Tidak Ada Masalah</option>
                    @foreach($lossa as $a)
            ...
            <td><input type="time" data-placement="top" data-trigger="manual" data-content="Required"
                    wire:model.defer="problem01.finish" style="width:100px" class="form-control" name="regfinish0">
            </td>
            ...
            <td><input type="text" data-placement="top" data-trigger="manual" class="form-control"
                    wire:model.defer="problem01.ket">
            </td>
            <td align="right"><button class="btn btn-success" type="submit" wire:click="plus01">Submit</button></td>
        </tr>
        <tr>
        ...
        <tr>
            ...
            <td><input disabled value="{{$d1->start}}" type="time" style="width:100px"
                    class="form-control-plaintext w-100"></td>
            <td><input disabled value="{{$d1->stop}}" type="time" style="width:100px"
                    class="form-control-plaintext w-100"></td>
            <td><input disabled value="{{$d1->dur}}" type="number" style="width:100px"
                    class="form-control-plaintext w-100"></td>
            <td><input disabled value="{{$d1->tipe}}" type="text" class="form-control-plaintext w-100">
            <td><input disabled type="text" value="{{$d1->ket}}" class="form-control-plaintext w-100" name="regket">
            </td>
            <td align="right"><button class="btn btn-danger" type="submit" wire:click="delprob('{{$d1->id}}')"><i
    ...
    <table>
        <tr>
            ...
            <td><input wire:model.defer="problem02.finish" type="time" style="width:100px" class="form-control">
            </td>
            ...
            <td align="right"><button class="btn btn-success" type="submit" wire:click="plus02">Submit</button></td>
        </tr>
        <tr>
            <td style="width:25%" align="center">Masalah Yang Terjadi</td>
            <td style="width:5%" align="center">Start</td>
        ...
        <tr>
            ...
            <td><input disabled value="{{$d2->start}}" type="time" style="width:100px"
                    class="form-control-plaintext w-100"></td>
            <td><input disabled value="{{$d2->stop}}" type="time" style="width:100px"
                    class="form-control-plaintext w-100"></td>
            <td><input disabled value="{{$d2->dur}}" type="number" style="width:100px"
                    class="form-control-plaintext w-100"></td>
            <td><input value="{{$d2->tipe}}" disabled type="text" class="form-control-plaintext w-100"></td>
            <td><input disabled type="text" value="{{$d2->ket}}" class="form-control-plaintext w-100" name="wrkket">
            </td>
            <td align="right"><button class="btn btn-danger" type="submit" wire:click="delprob('{{$d2->id}}')"><i
    ...
    <table>
        <tr>
            <td><select wire:model.defer="problem03.masalah" class="custom-select">
                    <option selected value="Tidak Ada Masalah" selected>Tidak Ada Masalah</option>
                    @foreach($lossc as $c)
            ...
            <td><input wire:model.defer="problem03.finish" type="time" style="width:100px" class="form-control">
            </td>
            <td><input disabled type="number" style="width:100px" class="form-control"></td>
            <td>
            ...
            <td align="right"><button class="btn btn-success" type="submit" wire:click="plus03">Submit</button></td>
        </tr>
        <tr>
            <td style="width:25%" align="center">Masalah Yang Terjadi</td>
            <td style="width:5%" align="center">Start</td>
        ...
        <tr>
            ...
            <td><input disabled value="{{$d3->start}}" type="time" style="width:100px"
                    class="form-control-plaintext w-100"></td>
            <td><input disabled value="{{$d3->stop}}" type="time" style="width:100px"
                    class="form-control-plaintext w-100"></td>
            <td><input disabled value="{{$d3->dur}}" type="number" style="width:100px"
                    class="form-control-plaintext w-100"></td>
            ...
            <td align="right"><button class="btn btn-danger" type="submit" wire:click="delprob('{{$d3->id}}')"><i
                        class="fa fa-minus-circle" aria-hidden="true"></i></button></td>
        </tr>
        @endforeach
    </table>
    ...
    <table>
        <tr>
            ...
            <td><input wire:model.defer="problem04.finish" type="time" style="width:100px" class="form-control">
            </td>
            <td><input disabled type="number" style="width:100px" class="form-control"></td>
            <td>
            ...
            <td align="right"><button class="btn btn-success" type="submit" wire:click="plus04">Submit</button></td>
        </tr>
        <tr>
            <td style="width:25%" align="center">Masalah Yang Terjadi</td>
            <td style="width:5%" align="center">Start</td>
        ...
        <tr>
            ...
            <td><input disabled value="{{$d4->start}}" type="time" style="width:100px" class="form-control-plaintext">
            </td>
            <td><input disabled value="{{$d4->stop}}" type="time" style="width:100px" class="form-control-plaintext">
            </td>
            <td><input disabled value="{{$d4->dur}}" type="number" style="width:100px" class="form-control-plaintext">
            </td>
            ...
            <td align="right"><button class="btn btn-danger" type="submit" wire:click="delprob('{{$d4->id}}')"><i
                        class="fa fa-minus-circle" aria-hidden="true"></i></button></td>
        </tr>
        @endforeach
    </table>
    ...
    <table style="width:100%">
        ...
        <tr>
            ...
            <td>
                <div class="input-group"><input wire:model.defer="result.avail" type="number" class="form-control"
                        name="reslt5">
